...
{
    public function test_authentication_category()
    {
    ...
    public function test_authentication_genres()
    {
    ...
    public function test_authentication_cast_members()
    {
    ...
    public function test_authentication_video()
    {
